...
`Python 3.10+` · `242 tests, all green` · `MIT license` · `fail-safe OFF by default`
...
tests/               242 tests: unit, integration, failure, red-team, e2e
...
pip install -e ".[dev]"
python -m pytest tests/                 # 242 tests, no network needed
...
```bash
python -m pytest tests/                                        # offline, 242 tests
