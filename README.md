...
`Python 3.10+` · `246 tests, all green` · `MIT license` · `fail-safe OFF by default`
...
tests/               246 tests: unit, integration, failure, red-team, e2e
...
pip install -e ".[dev]"
python -m pytest tests/                 # 246 tests, no network needed
...
```bash
python -m pytest tests/                                        # offline, 246 tests
